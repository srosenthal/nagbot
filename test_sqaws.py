...
class TestAws(unittest.TestCase):
    ...
    def test_stop_instance_exception(self, mock_client):
        ...
        assert not sqaws.stop_instance(region, instance_id)
    ...
    def test_terminate_instance(self, mock_client):
        ...
        assert sqaws.terminate_instance(region, instance_id)
    ...
    def test_terminate_instance_exception(self, mock_client):
        ...
        assert not sqaws.terminate_instance(region, instance_id)
